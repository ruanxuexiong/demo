 ...
 *
 */
public class LineChartActivity extends CommonActivity {
	...
	private int chat_margin_left = 30;
	private int chat_margin_right = 30;
	...
	public void initParams(Bundle parms) {
		chat_margin_left = ToolUnit.dipTopx(this,30);
		chat_margin_right = ToolUnit.dipTopx(this,30);
	}
	...
	public void initView(View view) {
		...
		//提示信息窗口宽高
		mPopTipsWidth = ToolUnit.dipTopx(this,100);
		mPopTipsHeight = ToolUnit.dipTopx(this,60);
...
//      ActionBarManager.initBackTitle(getContext(), getActionBar(), strCenterTitle);
	...
	private void configRenderer(XYMultipleSeriesRenderer renderer)
	{
		...
		//TODO 设置坐标轴刻度字体大小
		renderer.setLabelsTextSize(ToolUnit.pxTosp(this,axisTextSize));
		//TODO 设置点大小
		renderer.setPointSize(ToolUnit.pxTodip(this,pointSize));
		//是否显示缩放按钮
	...
	private void setRenderer(XYMultipleSeriesRenderer renderer, int[] colors,PointStyle[] styles) {
		...
		for (int i = 0; i < length; i++) {
			...
			r.setColor(colors[i]);
			// 设置线的宽度
			r.setLineWidth(ToolUnit.pxTodip(this,lineWidth));
			//点的风格样式
