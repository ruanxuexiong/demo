...
public final class PullToRefreshListActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		soundListener.addSoundEvent(State.PULL_TO_REFRESH, R.raw.widget_pull_event);
		soundListener.addSoundEvent(State.RESET, R.raw.widget_reset_sound);
		soundListener.addSoundEvent(State.REFRESHING, R.raw.widget_refreshing_sound);
