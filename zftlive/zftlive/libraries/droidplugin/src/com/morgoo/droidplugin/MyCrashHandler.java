 ...
 */
public class MyCrashHandler implements UncaughtExceptionHandler,IConstanst {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        try {
            ...
            File file = new File(Environment.getExternalStorageDirectory(), String.format(SDCARD_CRASH_LOG_DIR +"CrashLog_%s_%s.log", dateStr, android.os.Process.myPid()));
