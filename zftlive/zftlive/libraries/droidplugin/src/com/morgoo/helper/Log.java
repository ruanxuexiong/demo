 ...
 */
public class Log implements IConstanst {
    ...
    private static final long MAX_LOG_FILE = IConstanst.LOG_FILE_MAX_SIZE;

    private static boolean sDebug = IS_DEBUG;
    private static boolean sFileLog = IS_WRITTE_FILE_LOG;
    ...
    private static final File sDir = new File(Environment.getExternalStorageDirectory(), SDCARD_PLUGIN_LOG_DIR);
    ...
    private static File getLogFile() {
        File file = new File(Environment.getExternalStorageDirectory(), String.format(SDCARD_LOG_DIR+"Log_%s_%s.log", sFormat1.format(new Date()), android.os.Process.myPid()));
