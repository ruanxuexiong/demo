...
import com.zftlive.android.library.widget.dialog.effects.BaseEffects;
import com.zftlive.android.library.widget.dialog.effects.FadeIn;
import com.zftlive.android.library.widget.dialog.effects.Fall;
import com.zftlive.android.library.widget.dialog.effects.FlipH;
import com.zftlive.android.library.widget.dialog.effects.FlipV;
import com.zftlive.android.library.widget.dialog.effects.NewsPaper;
import com.zftlive.android.library.widget.dialog.effects.RotateBottom;
import com.zftlive.android.library.widget.dialog.effects.RotateLeft;
import com.zftlive.android.library.widget.dialog.effects.Shake;
import com.zftlive.android.library.widget.dialog.effects.SideFall;
import com.zftlive.android.library.widget.dialog.effects.SlideBottom;
import com.zftlive.android.library.widget.dialog.effects.SlideLeft;
import com.zftlive.android.library.widget.dialog.effects.SlideRight;
import com.zftlive.android.library.widget.dialog.effects.SlideTop;
import com.zftlive.android.library.widget.dialog.effects.Slit;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public static NiftyDialogBuilder getInstance(Context context) {
        ...
        if (instance == null || !tmpContext.equals(context)) {
            synchronized (NiftyDialogBuilder.class) {
                if (instance == null || !tmpContext.equals(context)) {
                    instance = new NiftyDialogBuilder(context,R.style.Widget_Dialog_Untran);
                }
            }
        }
        tmpContext = context;
    ...
    private void init(Context context) {
        ...
        mDialogView = View.inflate(context, R.layout.widget_nifty_dialog_layout, null);
    ...
    public static enum  Effectstype {
