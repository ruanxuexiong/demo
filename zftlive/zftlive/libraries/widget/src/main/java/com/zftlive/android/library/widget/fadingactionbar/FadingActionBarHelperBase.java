...
public abstract class FadingActionBarHelperBase {
    ...
    private View createWebView() {
        ViewGroup webViewContainer = (ViewGroup) mInflater.inflate(R.layout.widget_fab_webview_container, null);
    ...
    private View createScrollView() {
        ViewGroup scrollViewContainer = (ViewGroup) mInflater.inflate(R.layout.widget_fab_scrollview_container, null);
    ...
    private View createListView(ListView listView) {
        ViewGroup contentContainer = (ViewGroup) mInflater.inflate(R.layout.widget_fab_listview_container, null);
        contentContainer.addView(mContentView);
    ...
    private void initializeGradient(ViewGroup headerContainer) {
        ...
        int gradient = R.drawable.widget_shape_fab_gradient_n;
        if (mLightActionBar) {
            gradient = R.drawable.widget_shape_fab_gradient_light;
        }
