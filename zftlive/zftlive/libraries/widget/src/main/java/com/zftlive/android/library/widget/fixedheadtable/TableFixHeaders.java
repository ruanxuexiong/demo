...
public class TableFixHeaders extends ViewGroup {
	...
	public TableFixHeaders(Context context, AttributeSet attrs) {
		...
		this.shadows[0].setImageResource(R.drawable.widget_shape_fixheadtable_shadow_left);
		this.shadows[1] = new ImageView(context);
		this.shadows[1].setImageResource(R.drawable.widget_shape_fixheadtable_shadow_top);
		this.shadows[2] = new ImageView(context);
		this.shadows[2].setImageResource(R.drawable.widget_shape_fixheadtable_shadow_right);
		this.shadows[3] = new ImageView(context);
		this.shadows[3].setImageResource(R.drawable.widget_shape_fixheadtable_shadow_bottom);

		this.shadowSize = getResources().getDimensionPixelSize(R.dimen.widget_shadow_size);
	...
	public void removeView(View view) {
		...
		final int typeView = (Integer) view.getTag(R.id.widget_tag_type_view);
	...
	protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
		...
		final Integer row = (Integer) child.getTag(R.id.widget_tag_row);
		final Integer column = (Integer) child.getTag(R.id.widget_tag_column);
	...
	private View makeView(int row, int column, int w, int h) {
		...
		view.setTag(R.id.widget_tag_type_view, itemViewType);
		view.setTag(R.id.widget_tag_row, row);
		view.setTag(R.id.widget_tag_column, column);
