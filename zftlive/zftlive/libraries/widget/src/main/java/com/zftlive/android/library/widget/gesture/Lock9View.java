...
public class Lock9View extends ViewGroup {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs, int defStyleAttr) {
        // 获取定义的属性
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.Widget_Lock9View, defStyleAttr, 0);

        nodeSrc = a.getDrawable(R.styleable.Widget_Lock9View_anl_lock9_nodeSrc);
        nodeOnSrc = a.getDrawable(R.styleable.Widget_Lock9View_anl_lock9_nodeOnSrc);
        nodeSize = a.getDimension(R.styleable.Widget_Lock9View_anl_lock9_nodeSize, 0);
        nodeAreaExpand = a.getDimension(R.styleable.Widget_Lock9View_anl_lock9_nodeAreaExpand, 0);
        nodeOnAnim = a.getResourceId(R.styleable.Widget_Lock9View_anl_lock9_nodeOnAnim, 0);
        lineColor = a.getColor(R.styleable.Widget_Lock9View_anl_lock9_lineColor, Color.argb(0, 0, 0, 0));
        lineWidth = a.getDimension(R.styleable.Widget_Lock9View_anl_lock9_lineWidth, 0);
        padding = a.getDimension(R.styleable.Widget_Lock9View_anl_lock9_padding, 0);
        spacing = a.getDimension(R.styleable.Widget_Lock9View_anl_lock9_spacing, 0);

        enableVibrate = a.getBoolean(R.styleable.Widget_Lock9View_anl_lock9_enableVibrate, false);
        vibrateTime = a.getInt(R.styleable.Widget_Lock9View_anl_lock9_vibrateTime, 20);
