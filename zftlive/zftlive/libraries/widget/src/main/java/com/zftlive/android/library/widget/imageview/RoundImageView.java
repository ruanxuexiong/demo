...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		TypedArray a = mContext.obtainStyledAttributes(attrs,
				R.styleable.Widget_RoundedImageView);
		mBorderThickness = a.getDimensionPixelSize(
				R.styleable.Widget_RoundedImageView_anl_border_thickness, 0);
		mBorderOutsideColor = a
				.getColor(R.styleable.Widget_RoundedImageView_anl_border_outside_color,
						defaultColor);
		mBorderInsideColor = a.getColor(
				R.styleable.Widget_RoundedImageView_anl_border_inside_color, defaultColor);
	}
