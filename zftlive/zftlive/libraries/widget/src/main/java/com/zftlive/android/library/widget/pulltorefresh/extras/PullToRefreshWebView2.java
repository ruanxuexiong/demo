 ...
 * triggering of the Widget_PullToRefresh gesture to the Javascript running within the
 ...
 * <p/>
 * <p/>
 * The way this call works is that when a Widget_PullToRefresh gesture is in action,
 * the following Javascript methods will be called:
 * <code>isReadyForPullDown()</code> and <code>isReadyForPullUp()</code>, it is
 * your job to calculate whether the view is in a state where a Widget_PullToRefresh
