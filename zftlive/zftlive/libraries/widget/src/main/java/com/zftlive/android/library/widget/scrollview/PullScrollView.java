...
public class PullScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.Widget_PullScrollView);

            if (ta != null) {
                mHeaderHeight = (int) ta.getDimension(R.styleable.Widget_PullScrollView_anl_headerHeight, -1);
                mHeaderVisibleHeight = (int) ta.getDimension(R.styleable
                        .Widget_PullScrollView_anl_headerVisibleHeight, -1);
                ta.recycle();
            }
        }
    }
