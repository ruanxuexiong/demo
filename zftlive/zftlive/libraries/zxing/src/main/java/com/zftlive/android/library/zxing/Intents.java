...
public final class Intents {
  ...
  public static final class Encode {
    ...
    /**
     * Normally the contents of the barcode are displayed to the user in a Widget_TextView. Setting this
     * boolean to false will hide that Widget_TextView, showing only the encode barcode.
     */
