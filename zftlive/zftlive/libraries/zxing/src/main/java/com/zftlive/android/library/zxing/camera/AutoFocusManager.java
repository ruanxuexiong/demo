...
package com.zftlive.android.library.zxing.camera;
...
import com.zftlive.android.library.zxing.config.Config;
...
final class AutoFocusManager implements Camera.AutoFocusCallback {
	...
	public synchronized void onAutoFocus(boolean success, Camera theCamera) {
		if (active) {
			...
			com.zftlive.android.library.zxing.common.Runnable.execAsync(outstandingTask);
		}
	}
